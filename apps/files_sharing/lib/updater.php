...
class Shared_Updater {
	 ...
	 *
	 * The owner is allowed to move his files (if they are shared) into a receiving folder
	 * In this case we need to update the parent of the moved share. Since we are
